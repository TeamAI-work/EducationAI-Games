...
export default function FrictionSliderRow({ label, value, min, max, step = 0.01, unit, onChange, hint }) {
    ...
    <div className="flex flex-col gap-1.5">
      <div className="flex items-center justify-between gap-2">
        <div className="flex flex-col">
          <span className="text-xs font-medium shrink-0" style={{ color: CLR.muted }}>{label}</span>
